...
# Rota para receber mensagem do usuário
@app.post("/chat", response_class=HTMLResponse)
async def chat(request: Request, message: str = Form(...)):
    # Lógica simples de resposta automática
...
# Função p gerar resposta automática
def processar_mensagem(mensagem):
    mensagem = mensagem.lower()
    if "campeonatos" in mensagem:
            return "A FURIA está participando da IEM Katowice e de outros torneios incríveis!"
    elif "time" in mensagem:
        return "O lineup atual da FURIA é formado por KSCERATO, yuurih, chelo, FalleN e arT."
